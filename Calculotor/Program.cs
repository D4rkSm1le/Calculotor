...
namespace Calculotor
{
    internal class Program
    {
        ...
        {
            Console.WriteLine("калькулятор Куварина Глеба ");
...

            {
                ...
                
                {
                    if (q == "1")
                    {
                        ...
                        Console.WriteLine("Можно попробовать ещё одну операцию");
                ...
                {
                    Console.WriteLine(' ');
                    Console.WriteLine("Я не смог сделать факториал, Простите меня я на коленях стою(((((");
                }
                if (q == "9")
                {
                    Environment.Exit(0);
                ...
                {
                    Console.WriteLine(" ");
                    Console.WriteLine("бро числа от 1 до 9");
                }
